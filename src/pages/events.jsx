  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center text-white px-4 py-10">
      ...
      <div className="w-full sm:hidden text-center mb-4">
        <button
          onClick={toggleMenu}
          className="bg-[#4d208d] text-[#dfaa05] border-[#dfaa05] font-bold px-8 py-5 text-xl rounded-lg shadow-lgS hover:bg-[#dfaa05] hover:text-[#4d208d] transition-all w-full max-w-xs"
